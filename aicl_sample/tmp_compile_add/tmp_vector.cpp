...
aiclTensorDesc *aiclCreateTensorDesc(aiclDataType dataType, int numDims,
    ...
    case 1:
        ...
        break;
    case 2:
        std::vector<int64_t> shape{dims[0], dims[1]};
        break;
    case 3:
        std::vector<int64_t> shape{dims[0], dims[1], dims[2]};
        break;
    case 4:
        std::vector<int64_t> shape{dims[0], dims[1], dims[2], dims[3]};
        break;
    case 5:
        std::vector<int64_t> shape{dims[0], dims[1], dims[2], dims[3], dims[4]};
        break;
    default:
        break;
    }

    // change dataType to dtype
    switch (dataType)
    {
    case 0:   // AICL_FLOAT
    ...
    case 4:     // AICL_UINT8
        ...
        break;
    case 6:     // AICL_INT16
        DLDataType dtype{kDLInt, 16, 1};
        break;
    case 7:     // AICL_UINT16
        DLDataType dtype{kDLUInt, 16, 1};
        break;
    case 8:    // AICL_UINT32
        DLDataType dtype{kDLUInt, 32, 1};
        break;
    default:
        break;
    }

    return (aiclTensorDesc *)tvm::runtime::NDArray::Empty(shape, dtype, {kDLCPU, 0});
}
...
int main(){
    ...
    // aiclDataBuffer *input_bu;
    // aiclDataBuffer *output_bu;
