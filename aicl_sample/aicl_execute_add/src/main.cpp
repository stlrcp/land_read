...
bool RunAddOp(OperatorDesc *op_desc)
{
    // create op desc
...
bool InitResource()
{
    ...
    // if (aiclopSetModelDir("op_models") != AICL_RET_SUCCESS) {
    if (aiclopSetModelDir("./add.so") != AICL_RET_SUCCESS) {
